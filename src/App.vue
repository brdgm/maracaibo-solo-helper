<template>
  ...
  <ModalDialog id="creditsModal" :title="t('footer.credits')">
    <template #body>
      <h4><a href="https://boardgamegeek.com/boardgame/276025/maracaibo" target="_blank" rel="noopener">{{t('gameTitle')}}</a></h4>
      <dl>
        <dt>Game design</dt>
        <dd>Alexander Pfister</dd>
        <dt>Artist</dt>
        <dd>Fiore GmbH, Aline Kirrmann</dd>
        <dt>Publisher</dt>
      ...
      <dl>
        ...
        <dt>Version</dt>
        <dd>{{buildNumber}} (<a href="https://github.com/brdgm/maracaibo-solo-helper/releases" target="_blank" rel="noopener">Change Log</a>)</dd>
        <dt>Source Code (Apache-2.0 License)</dt>
        <dd><a href="https://github.com/brdgm/maracaibo-solo-helper" target="_blank" rel="noopener">https://github.com/brdgm/maracaibo-solo-helper</a></dd>
      </dl>
